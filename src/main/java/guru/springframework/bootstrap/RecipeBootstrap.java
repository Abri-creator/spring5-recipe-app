...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    //This method called getRecipes will return an object List
    private List<Recipe> getRecipes() {
        ...
        //if any of the values are not found in the database, it will throw an Exception
        ...
        //get optionals in UnitOfMeasure obj
        ...
        //set the relatioship between Notes and Recipe
        guacNotes.setRecipe(guacRecipe);
        guacRecipe.setNotes(guacNotes);
        //setting all ingredient
        ...
        // set the category which they belong
